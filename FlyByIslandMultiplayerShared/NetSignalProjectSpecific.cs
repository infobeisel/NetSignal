...
namespace NetSignal2Unity
{
    public struct NetSignalProjectSpecific
    {
        ...
        public static int ReliableSignalCountPerClient = NetSignal.ConnectionUpdater.ReservedReliableSignalCount + typeof(ReliableSignalIndices).GetFields().Length + NetSignal.ConnectionUpdater.ReservedUnreliableSignalCount + typeof(UnreliableSignalIndices).GetFields().Length;
