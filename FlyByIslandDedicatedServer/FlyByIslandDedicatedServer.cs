...
{
    internal class FlyByIslandDedicatedServer
    {
        ...
        private static async Task ChooseTerrainAndTrack(TimeControl timeControl, System.Random rng)
        {
        ...
        private static async Task Countdown(TimeControl timeControl)
        {
            for (int clientI = 0; clientI < reliableSignalsSentFromServer.Length; clientI++)
            {
        ...
        private static async Task Match(TimeControl timeControl)
        {
            for (int clientI = 0; clientI < reliableSignalsSentFromServer.Length; clientI++)
            {
        ...
        private static async Task HighScoreView(TimeControl timeControl)
        {
            for (int clientI = 0; clientI < reliableSignalsSentFromServer.Length; clientI++)
            {
