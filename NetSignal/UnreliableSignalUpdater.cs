...
namespace NetSignal
{
    public class UnreliableSignalUpdater
    {
        ...
        public static async void SyncSignalsToAll(OutgoingSignal[][][] signals, TimeControl timeControl, Action<string> report, Func<bool> cancel, ConnectionAPIs[] toAllApis, ConnectionMetaData[] toAllData, ConnectionState[] toAllStates, IEnumerable<int> toIndices)
        {
        ...
        public static async void ReceiveSignals(int withInd, ConnectionAPIs[] connection, ConnectionMetaData[] connectionData, ConnectionState[] connectionState, IncomingSignal[][][] signals, TimeControl timeControl, Func<bool> cancel, Action<string> report, params ConnectionMetaData[] from)
        {
