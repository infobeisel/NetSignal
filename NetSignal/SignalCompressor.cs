...
namespace NetSignal
{
    ...
    {
        public static unsafe void Decompress(Action<string> report, byte[] compressed, int startFrom, int toHistInd, IncomingSignal[][][] to, Action<int, int, int> perSignalUpdated)
        {
        ...
        public static unsafe int Compress(OutgoingSignal[] signals, int startFromSignalI, byte[] to, int startFromByteI, Action<string> report)
        {
        ...
        private static unsafe void EncodeIndexRangeInto64(int startI, int endI, byte[] to, int startFrom)
        {
        ...
        private static unsafe void EncodeClientIdInto32(int clientId, byte[] to, int startFrom)
        {
        ...
        private static unsafe void EncodeTimestampInto64(long ticks, byte[] to, int startFrom)
        {
        ...
        private static unsafe void EncodeSignalInto32(DataPackage package, byte[] to, int startFrom)
        {
        ...
        private static unsafe DateTime DecodeTimestamp(byte[] from, int startFromByteI)
        {
            long ticks = 0;
            byte* cIdPtr = (byte*)&ticks;
            for (int i = 0; i < 8; i++)
        ...
        private static unsafe int DecodeClientId(byte[] from, int startFromByteI)
        {
            int cid = -1;
        ...
        private static unsafe void DecodeIndexRange(byte[] from, int startFromByteI, out int startI, out int count)
        {
            int _startI = 0;
            int _count = 0;
        ...
        private static unsafe void DecodeSignalBytes(byte[] from, int startFromByteI, ref DataPackage to)
        {
        ...
        public static unsafe void Compress(DataPackage package, byte[] to, int startFrom)
        {
        ...
        public static unsafe DataPackage DecompressDataPackage(byte[] compressed, int startFrom)
        {
